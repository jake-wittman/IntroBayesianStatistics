...
# function to transform the adjacency and num(# of neighbors) to edges and nodes
...
fit.car <- stan(
    file = "car.stan",      
    data = list(N,N_edges,node1,node2,y,E,x),    
...
print(fit.car, pars=c('beta0','beta1','phi','eta','mu','alpha'),digits=3, probs=c(.025,.5,.975))
sample.para <- extract(fit.car, pars=c('beta0','beta1','phi','eta','mu','alpha'))
